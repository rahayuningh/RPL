  ...
  <section id="layanan">
    <div class="container">
      ...
      <div class="row">
          <!-- Prev/Next -->
          <div class="col-lg-12 text-center">
            <a href="/jenis_alat" class="btn btn-primary btn-m text-uppercase" style="margin:10px;">Prev</a>
            <a href="/keluhan" class="btn btn-primary btn-m text-uppercase"style="margin:10px;">Next</a>
          </div>
      </div>
    </form>
    </div>
